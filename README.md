...
It's an open source project that ports Android to the x86 architecture so it can be executed in the computers that have that CPU architecture. The project is not mine. This repository it's just a link for the ISOs I built, and a memo of the things I'm doing to archive the versions that are not in a ISO format.
...
2. If that doesn't give any result, ask someone. It's okay to ask, and if you ask me, I will try to help you. But, please if you do, be respectful and remember that this is a personal project and that I'm not a slave of anyone, not even working for anyone in particular.
...
Choose the boot entry in: Advanced Options -> Live - No Hardware Acceleration

Or you can follow the next steps:

1. Select your desired boot entry.
2. Press the key *E*
3. Add the parameter *nomodeset* to the line that starts with *linux*
4. Press the key *F10*
5. The Android boot screen should appear and the ISO will boot properly.
